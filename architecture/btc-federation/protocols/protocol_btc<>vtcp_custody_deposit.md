...
| `DEPOSIT_REVERSAL_CHALLENGE_PERIOD_SECONDS` |    10800     | The duration (in seconds) of the challenge window for a deposit reversal (defaulting to 3 hours). |
